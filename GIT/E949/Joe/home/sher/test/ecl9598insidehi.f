      program ecl9598insidehi
*
*    File:  ecl9598insidehi.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile9598insidehi
*           > ecl9598insidehi.exe >& ecl9598insidehi.dat
*           > awk -f ecl.awk ecl9598insidehi.dat >& ecl9598insidehi.vect
*           > eclresults
*
      implicit none
      include 'eclout.inc'
