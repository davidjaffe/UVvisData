      program ecl98insidehi
*
*    File:  ecl98insidehi.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile98insidehi
*           > ecl98insidehi.exe >& ecl98insidehi.dat
*           > awk -f ecl.awk ecl98insidehi.dat >& ecl98insidehi.vect
*           > eclresults
*
