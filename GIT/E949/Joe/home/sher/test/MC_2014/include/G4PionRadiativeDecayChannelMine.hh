...
//
// ------------------------------------------------------------
#ifndef G4PionRadiativeDecayChannelMine_hh
#define G4PionRadiativeDecayChannelMine_hh 1
...
inline G4double G4PionRadiativeDecayChannelMine::D2W(const G4double x, 
                                                 const G4double y)
{
