      program ecl9598total
*
*    File:  ecl9598total.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile9598total
*           > ecl9598total.exe >& ecl9598total.dat
*           > awk -f ecl.awk ecl9598total.dat >& ecl9598total.vect
*           > eclresults
*
...
c
      ...
      d(4692) = 1   ! Km2 L/R ambiguity event
