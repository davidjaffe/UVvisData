      program ecl9597insidelo
*
*    File:  ecl9597insidelo.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile9597insidelo
*           > ecl9597insidelo.exe >& ecl9597insidelo.dat
*           > awk -f ecl.awk ecl9597insidelo.dat >& ecl9597insidelo.vect
*           > eclresults
*
