      program ecl9598outside0
*
*    File:  ecl9598outside0.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile9598outside0
*           > ecl9598outside0.exe >& ecl9598outside0.dat
*           > awk -f ecl.awk ecl9598outside0.dat >& ecl9598outside0.vect
*           > eclresults
*
