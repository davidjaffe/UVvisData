      program ecl98outside0
*
*    File:  ecl98outside0.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile98outside0
*           > ecl98outside0.exe >& ecl98outside0.dat
*           > awk -f ecl.awk ecl98outside0.dat >& ecl98outside0.vect
*           > eclresults
*
