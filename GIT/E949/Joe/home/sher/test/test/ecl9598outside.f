      program ecl9598outside
*
*    File:  ecl9598outside.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile9598outside
*           > ecl9598outside.exe >& ecl9598outside.dat
*           > awk -f ecl.awk ecl9598outside.dat >& ecl9598outside.vect
*           > eclresults
*
...
c
      ...
      d(87) = 1     ! 1998 signal event
      d(963) = 1    ! signal-like event (bgtd = 3.1)
