      program ecl9597insidehi
*
*    File:  ecl9597insidehi.f
* Purpose:  single-channel tester for eclsyst.f -- find CL
*           for different values of the K -> pnn BR
*   Usage:  > make -f Makefile9597insidehi
*           > ecl9597insidehi.exe >& ecl9597insidehi.dat
*           > awk -f ecl.awk ecl9597insidehi.dat >& ecl9597insidehi.vect
*           > eclresults
*
