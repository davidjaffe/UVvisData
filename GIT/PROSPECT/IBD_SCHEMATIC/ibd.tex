...
%  \coordinate (capture_gd)   at ($(neutron_gd)!.95!20:(togdH)$);
  ...
  \node [black,fill=white,text opacity=1, fill opacity = 0.4] at (triton)       {\Large$\mathbf\tau$};
 ...
 \path (gd)       node [Green!80!black,eq,anchor=south,xshift=1.50cm,yshift=.5cm]    
 			{\large$\text{E}_\text{visible}\approx0.5\text{ MeV}$}; %\sum E_\gamma=
  ...
  \draw node (labelngd) [anchor=north west,yshift=5.5mm] at (cut2) {{n${}^6$Li {\footnotesize(main)}}};
